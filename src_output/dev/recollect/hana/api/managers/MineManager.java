...
implements Wrapper {
    ...
    public MineManager() {
        MineManager a;
        MineManager mineManager = a;
        mineManager.breakMap = new HashMap();
    ...
    public boolean isMining(class_2338 a) {
        ...
        BreakData breakData;
        MineManager mineManager = a2;
        boolean bl = false;
        a2 = new HashMap<Integer, BreakData>(mineManager.breakMap).values().iterator();
        block0 : do {
            ...
            do {
                ...
                if (!(breakData.getEntity().method_33571().method_1022(a.method_46558()) > 7.0)) continue block0;
                iterator = a2;
            } while (true);
