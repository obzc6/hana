 ...
 */
public class MioExplosionUtil
implements Wrapper {
    public static final class_1927 explosion;
    ...
    public static double anchorDamage(class_1657 class_16572, class_2338 class_23382, class_1657 class_16573) {
        ...
        if (BlockUtil.getBlock((class_2338)a2) == class_2246.field_23152) {
            ...
            double d = MioExplosionUtil.explosionDamage(a3, CombatUtil.modifyPos.method_46558(), (class_1657)a, 5.0000052f);
            CombatUtil.modifyPos = null;
            return d;
        }
        return MioExplosionUtil.explosionDamage(a3, a2.method_46558(), (class_1657)a, 5.0000052f);
    }
    ...
    public static float calculateDamage(class_243 class_2432, class_1657 class_16572, class_1657 class_16573, float f) {
        ...
        if (MioExplosionUtil.mc.field_1687 != null && MioExplosionUtil.mc.field_1687.method_8407() == class_1267.field_5801) {
            return 0.0f;
        }
        ...
        ((IExplosion)explosion).setWorld((class_1937)MioExplosionUtil.mc.field_1687);
        ...
        if (!a2.method_5659(explosion) && !a2.method_5655()) {
            ...
            if (d <= 1.0) {
                ...
                if ((double)class_3532.method_15355((float)((float)(d6 * d6 + d7 * d7 + d8 * d8))) != 0.0) {
                    ...
                    if (MioExplosionUtil.mc.field_1687.method_8407() == class_1267.field_5805) {
                        f2 = a32 = Math.min(a32 / 2.0f + 1.0f, a32);
                    } else {
                        if (MioExplosionUtil.mc.field_1687.method_8407() == class_1267.field_5807) {
                            a32 = a32 * 3.0f / 2.0f;
                        }
                        f2 = a32;
                    }
                    ...
                    int a5 = class_1890.method_8219((Iterable)a2.method_5661(), (class_1282)MioExplosionUtil.mc.field_1687.method_48963().method_48807(explosion));
                    if (a5 > 0) {
    ...
    private static /* synthetic */ double blastProtReduction(class_1297 class_12972, double d, class_1927 class_19272) {
        ...
        int a2 = 0;
        if (MioExplosionUtil.mc.field_1687 != null) {
            void a3;
            a2 = class_1890.method_8219((Iterable)class_12973.method_5661(), (class_1282)MioExplosionUtil.mc.field_1687.method_48963().method_48807((class_1927)a3));
        }
        if (a2 > 20) {
            a2 = 20;
        }
        a *= 1.0 - (double)a2 / 25.0025488497;
        if (v0 < 0.0) {
            return 0.0;
        }
        return (double)a;
    ...
    public static double explosionDamage(class_1657 class_16572, class_243 class_2432, class_1657 class_16573, float f) {
        ...
        double d2 = Math.sqrt(a.method_5707((class_243)a3));
        if (d > 10.0) {
            return 0.0;
        }
        double d3 = class_1927.method_17752((class_243)a3, (class_1297)a);
        d2 = (1.0 - d2 / 10.0) * d3;
        d2 = (d2 * d2 + d2) / 2.0 * 7.0 * 10.0 + 1.0000004;
        d2 = MioExplosionUtil.getDamageForDifficulty(d2);
        if (a4 != null) {
            d2 = MioExplosionUtil.resistanceReduction((class_1309)a4, d2);
        }
        if (a4 != null) {
            d2 = class_1280.method_5496((float)((float)d2), (float)a4.method_6096(), (float)((float)Objects.requireNonNull(a4.method_5996(class_5134.field_23725)).method_6194()));
        }
        ((IExplosion)explosion).setWorld((class_1937)MioExplosionUtil.mc.field_1687);
        ((IExplosion)explosion).setX(a3.field_1352);
        ((IExplosion)explosion).setY(a3.field_1351);
        ((IExplosion)explosion).setZ(a3.field_1350);
        ((IExplosion)explosion).setPower((float)a2);
        if (a4 != null) {
            d2 = MioExplosionUtil.blastProtReduction((class_1297)a4, d2, explosion);
        }
        if (d2 < 0.0) {
            d2 = 0.0;
        }
    ...
    static {
        boolean bl = $assertionsDisabled = !MioExplosionUtil.class.desiredAssertionStatus();
        if (!$assertionsDisabled && MioExplosionUtil.mc.field_1687 == null) {
            throw new AssertionError();
        }
        explosion = new class_1927((class_1937)MioExplosionUtil.mc.field_1687, null, 0.0, 0.0, 0.0, 6.0f, false, class_1927.class_4179.field_18687);
    }
    ...
    private static /* synthetic */ double resistanceReduction(class_1309 a3, double a2) {
        ...
        if (class_13092.method_6059(class_1294.field_5907)) {
            int a3 = Objects.requireNonNull(class_13092.method_6112(class_1294.field_5907)).method_5578() + 1;
            a2 *= 1.0 - (double)a3 * 0.200021;
        }
        if (a2 < 0.0) {
            return 0.0;
        }
