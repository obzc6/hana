...
public class AutoBurrow.PlayerAndPredict {
    class_1657 predict;
    final /* synthetic */ AutoBurrow this$0;
    class_1657 player;

    public AutoBurrow.PlayerAndPredict(AutoBurrow autoBurrow, class_1657 class_16572) {
        Iterator a;
        AutoBurrow.PlayerAndPredict a2 = class_16572;
        AutoBurrow.PlayerAndPredict a3 = this;
        a3.this$0 = a;
        a3.player = a2;
        if (((AutoBurrow)a).predictTicks.getValueFloat() > 0.0f) {
            AutoBurrow.PlayerAndPredict playerAndPredict = a3;
            playerAndPredict.predict = new class_1657(a3, (class_1937)Wrapper.mc.field_1687, a2.method_24515(), a2.method_36454(), new GameProfile(UUID.fromString(SocketClient.ALLATORIxDEMO("\u000f*[}-\r\u00141\u0002;\u0005!\u001f#\t-<\u0018\r3\u001c9(\u0016\n/\u001c;\u001c<\u001f4\u001b>\n/")), Packet.ALLATORIxDEMO("NKOiaLk}pMz@`\r=\u0010")), (AutoBurrow)((Object)a)){
                final /* synthetic */ AutoBurrow.PlayerAndPredict this$1;
            ...
            AutoBurrow.PlayerAndPredict playerAndPredict2 = a2;
