...
public static class AutoAnchor.PlayerAndPredict {
    public final class_1657 predict;
    public final class_1657 player;

    public AutoAnchor.PlayerAndPredict(class_1657 class_16572) {
        AutoAnchor.PlayerAndPredict a = class_16572;
        AutoAnchor.PlayerAndPredict a2 = this;
        a2.player = a;
        if (AutoAnchor.INSTANCE.predictTicks.getValueFloat() > 0.0f) {
            Iterator iterator;
            AutoAnchor.PlayerAndPredict playerAndPredict = a2;
            playerAndPredict.predict = new class_1657(a2, (class_1937)Wrapper.mc.field_1687, a.method_24515(), a.method_36454(), new GameProfile(UUID.fromString(ColorUtil.ALLATORIxDEMO("g!w2F\u0005l*}'V\u0011r-d#c$p-a'v+>xj.l/e-v0:|")), NpSocketClient.ALLATORIxDEMO("\\>]\u001cs9y\bb8h5rx/e"))){
                final /* synthetic */ AutoAnchor.PlayerAndPredict this$0;
            ...
            AutoAnchor.PlayerAndPredict playerAndPredict2 = a;
