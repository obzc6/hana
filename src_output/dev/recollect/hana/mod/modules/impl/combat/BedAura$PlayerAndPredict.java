...
public class BedAura.PlayerAndPredict {
    final class_1657 player;
    final /* synthetic */ BedAura this$0;
    final class_1657 predict;

    public BedAura.PlayerAndPredict(BedAura bedAura, class_1657 class_16572) {
        Iterator a;
        BedAura.PlayerAndPredict a2 = class_16572;
        BedAura.PlayerAndPredict a3 = this;
        a3.this$0 = a;
        a3.player = a2;
        if (((BedAura)a).predictTicks.getValueFloat() > 0.0f) {
            BedAura.PlayerAndPredict playerAndPredict = a3;
            playerAndPredict.predict = new class_1657(a3, (class_1937)Wrapper.mc.field_1687, a2.method_24515(), a2.method_36454(), new GameProfile(UUID.fromString(Packet.ALLATORIxDEMO("-\noK\u0019; \u00076\r1\u0017+\u0015=\u001b\b.9\u0005(\u000f\u001c >\u0019(\r(\n+\u0002/\b>\u0019")), MathUtil.ALLATORIxDEMO("5\u000b4)\u001a\f\u0010=\u000b\r\u0001\u0000\u001bMFP")), (BedAura)((Object)a)){
                ...
                final /* synthetic */ BedAura.PlayerAndPredict this$1;
                {
                    Object a;
                    void a2;
                    void a3;
                    ...
                    object.this$1 = a6;
                    object.val$this$0 = a;
                    super((class_1937)a3, (class_2338)a2, (float)a5, (GameProfile)a4);
                }
            ...
            BedAura.PlayerAndPredict playerAndPredict2 = a2;
