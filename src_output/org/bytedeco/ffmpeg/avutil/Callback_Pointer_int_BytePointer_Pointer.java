...
extends FunctionPointer {
    protected Callback_Pointer_int_BytePointer_Pointer() {
        Callback_Pointer_int_BytePointer_Pointer a;
        Callback_Pointer_int_BytePointer_Pointer callback_Pointer_int_BytePointer_Pointer = a;
        callback_Pointer_int_BytePointer_Pointer.allocate();
    }
    ...
    public Callback_Pointer_int_BytePointer_Pointer(Pointer pointer) {
        Callback_Pointer_int_BytePointer_Pointer a = pointer;
        Callback_Pointer_int_BytePointer_Pointer a2 = this;
        super((Pointer)a);
    }
}
